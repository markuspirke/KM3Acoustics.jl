...
@testset "eventbuilder" begin
    ...
    t1 = Transmission(1, 1, 1.0, 1.0, 1.1)
    t2 = Transmission(1, 1, 1.0, 1.0, 1.2)
    t3 = Transmission(1, 1, 1.0, 1.0, 1.25)
    t4 = Transmission(1, 1, 1.0, 1.0, 1.46)
    t5 = Transmission(1, 1, 1.0, 1.0, 1.5)
    e1 = Event(1, 1, 1, [t1, t2, t3])
    e2 = Event(1, 1, 1, [t2, t3])
