...
@testset "soundvelocity" begin
    ...
    mod = DetectorModule(1, pos_mod, Location(0, 0), 0, PMT[], missing, 0, missing)
    mod_rel = DetectorModule(1, pos_mod_rel, Location(0, 0), 0, PMT[], missing, 0, missing)
    ...
    mod1 = DetectorModule(1, pos_mod1, Location(0, 0), 0, PMT[], missing, 0, missing)
    pos_mod1_rel = Position(0.0,0.0,0.0)
    mod1_rel = DetectorModule(1, pos_mod1_rel, Location(0, 0), 0, PMT[], missing, 0, missing)
    mod2 = DetectorModule(1, Position(1541.0,0.0,-2000.0), Location(0, 0), 0, PMT[], missing, 0, missing)
    mod2_rel = DetectorModule(1, Position(1541.0,0.0, 0.0), Location(0, 0), 0, PMT[], missing, 0, missing)
